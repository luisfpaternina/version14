...
class BimIte(models.Model):
    ...
    name = fields.Char('Code', default=_('New'))
    ...
    def create(self, vals):
        if vals.get('name', _('New')) == _('New'):
            vals['name'] = self.env['ir.sequence'].next_by_code('bim.ite') or _('New')
...
class BimIteLine(models.Model):
    ...
    amount = fields.Float('Balance', help="Balance", compute='_compute_amount')
    qty_calc = fields.Float('Quantity', help="Quantity", compute='_compute_quantity')
